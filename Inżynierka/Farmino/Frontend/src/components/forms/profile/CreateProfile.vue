<template>
  <div id="profile-form">
    ...
    <div id="inputs-wraper">
      ...
      <div id="inputs-wraper">
        <label for="city" :class="[!$v.profile.address.city.$error ? 'form-label' : 'error-label']"
          >Miasto</label
        >
        <input
          type="text"
      ...
      <div id="inputs-wraper">
        ...
        <div id="error-message-wraper" v-if="$v.profile.address.street.$error">
          <p class="error-message" v-if="!$v.profile.address.street.required">Pole jest wymagane</p>
        </div>
      </div>
      <div id="inputs-wraper">
        <label
